...
class BacklogDetailsApiEventVersion2ComponentTest(BaseTestAjax):
    def setUp(self, path=reverse('jira:backlogDetailsApiEventVersion2Component', kwargs={'boardId': 0})) -> None:
        self.basePath = path
        super(BacklogDetailsApiEventVersion2ComponentTest, self).setUp(self.basePath)
    ...
    def testGetScrumBoardBacklogDetails(self):
        ...
        path = reverse('jira:backlogDetailsApiEventVersion2Component', kwargs={'boardId': testParams.board.id})
        faker = Faker()
